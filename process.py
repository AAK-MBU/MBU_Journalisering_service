...
def main_process(form, credentials, cases_metadata, db_env="PROD") -> None:
    ...
    status_params_inprogress, status_params_success, status_params_failed = (
    ...
    try:
        ...
        # continue
    # case_id = "BOR-2025-000882-011"
    # case_title = "Hjemmeundervisning af Dagmar Sode Hørlück"
    # case_rel_url = "BOR1161/BOR-2025-000882/SubNav/SubCase.aspx?FilterField1=CCMSubID&FilterValue1=011&CCMSubID=011"

    # print(f"Inserting manual case id: {case_id}")
...
def handle_error(message, case_metadata, error, process_name, db_env="PROD", form=None):
    """Function to log and notify on errors"""
    log_event(LOG_DB, "ERROR", message, context=f"{LOG_CONTEXT} ({process_name})", db_env=db_env)
    notify_stakeholders(
        case_metadata=case_metadata,
        case_id=None,
        case_title=None,
